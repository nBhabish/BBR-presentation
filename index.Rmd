...
- Plugging in a negative value for Change in Soybean production in the equation below has a positive association with Change in Democratic Vote Share from 2016 to 2018.
...
1. USDA has not reported soybean and corn production data for many counties in 2018 which reduces the number of observations when regressing the dependent variable to the independent variable in the model.
...
2. This effect is slightly reduced as soon as historical voting pattern is controlled for. Historical voting pattern, the control variable, is accounted for by Change in Republican Vote Share from 2008 to 2010. 
...
5. Lastly, our analysis is only able to explain very little about the variance in change in Democratic Vote Share from 2016 to 2018 since our $R^2$ is very low.
]
